  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 pt-16 md:pt-24">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-white shadow-md px-4 py-3 md:px-6 md:py-4 flex justify-between items-center">
        <Link
          to="/"
          className="text-xl md:text-2xl font-bold text-blue-600 hover:underline"
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-white text-center">
          ...
          <button onClick={() => navigate('/cart')} className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded text-white">
            Shop Now
          </button>
        </div>
      </div>
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="flex justify-center mt-2">
              <span className="bg-blue-600 text-white px-4 py-1 rounded inline-block pointer-events-none">
                View Product
              </span>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-10 mt-12">
        ...
        <div className="text-center text-gray-500 text-xs mt-6 border-t border-gray-700 pt-4 flex flex-col items-center gap-2">
          <button
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className="text-orange-400 hover:underline bg-blue-600 hover:bg-blue-700 px-2 py-1 rounded"
          >
            ↑ Back to Top
          </button>
